...
def main():
    ...
    init_db(conn)
    show(conn, "TRADES", "SELECT position_id,symbol,direction,status,net_pnl,r_multiple,strategy,setup,grade,rule_violation,emotion,primary_screenshot_path FROM trades ORDER BY entry_time_msc DESC")
